This code calculates the mathematical (and physical) constant e, which is roughly equal to 2.718281828459045. 
The program calculates this by adding 1 to the inverse of an n-value, and then raising it to the power of that number n (I'll call the given n-value a seed from now on).
